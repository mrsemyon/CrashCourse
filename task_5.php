<?php
    $data = [
        [
            ...
            'site' => 'wrapbootstrap.com/user/myorange',
            'contact' => 'Sunny',
        ],
        [
            ...
            'twitter' => '@atlantez',
            'site' => 'wrapbootstrap.com/user/Walapa',
            'contact' => 'Jos',
        ],
        [
            ...
            'position' => 'Partner &amp; Contributor',
            'twitter' => '@lodev09',
            'site' => 'wrapbootstrap.com/user/lodev09',
            'contact' => 'Jovanni',
        ],
        [
            ...
            'position' => 'Partner &amp; Contributor',
            'twitter' => '@sildur',
            'site' => 'wrapbootstrap.com/user/sildur',
            'contact' => 'Roberto',
        ],
    ];
?>
                        ...
                        <div class="panel-content">
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?=$item['img_src'];?>" alt="<?=$item['img_alt'];?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                        <?=$item['name'];?>
                                    ...
                                    <a href="https://<?=$item['site'];?>" class="text-info fs-sm" target="_blank" title="Contact <?=$item['contact'];?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
                            <?php }?>
                        </div>
